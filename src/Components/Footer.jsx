...
const Footer = () => {
  return (
    <footer className="footer-shell bg-slate-100 pt-16 pb-8 px-4">
      <div className="footer-inner mx-auto max-w-7xl">
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-x-20 mt-12">
            ...
            <div className="max-w-md flex flex-col items-center">
              ...
              <div className="mt-6">
                <p className="text-slate-600 leading-relaxed text-sm">
                  Powering Your World with the Best in Products. 123 Products
                  St, Style City, NY 10001 Email: support@Logo.com Phone: (123)
                  456-7890
                </p>
              </div>
            </div>
          ...
          <div className="space-y-6">
            <h3 className="text-slate-900 font-semibold text-xl">Follow Us</h3>
          ...
          <div className="space-y-6">
            <h3 className="text-slate-900 font-semibold text-xl">Pages</h3>
      ...
      <div className="footer-bottom">
        <p className="text-slate-600 text-sm text-center">
          © Made by Fahad Abdullah. All rights reserved.
        </p>
      </div>
    </footer>
  );
